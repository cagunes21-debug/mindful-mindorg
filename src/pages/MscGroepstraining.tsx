          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-3 gap-8 text-center">
              <div>
                ...
                <p className="text-sm text-muted-foreground">{tx("deelnemers begeleid")}</p>
              </div>
              <div>
                <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <p className="text-sm text-muted-foreground">{tx("gemiddelde beoordeling")}</p>
              </div>
              <div>
                <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <p className="text-sm text-muted-foreground">{tx("gecertificeerde trainer")}</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <ScrollReveal>
              ...
              <div className="space-y-6">
                <div className="bg-warm-50 rounded-2xl p-6 lg:p-8 border-l-4 border-terracotta-300">
                  ...
                  <p className="text-muted-foreground text-lg lg:text-xl leading-relaxed">
                    {tx("Veel mensen denken dat streng zijn voor jezelf helpt om gemotiveerd of succesvol te blijven.")}
                  </p>
                </div>
              ...
              <div className="mt-8 relative">
                ...
                <blockquote className="bg-white border border-warm-200 rounded-2xl p-6 lg:p-8 pl-10 italic text-lg lg:text-xl text-muted-foreground leading-relaxed shadow-sm">
                  {tx("\"Met dezelfde vriendelijkheid naar jezelf kijken als naar een goede vriend — dat is de kern van zelfcompassie.\"")}
                  <footer className="mt-4 not-italic text-base font-medium text-terracotta-600">
                    {tx("— Dr. Kristin Neff, grondlegger van zelfcompassie-onderzoek")}
                  </footer>
                </blockquote>
              </div>
              ...
              <div className="relative max-w-4xl mx-auto">
                ...
                <div className="relative aspect-video rounded-3xl overflow-hidden shadow-2xl border border-warm-200">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    ...
                    <p className="mt-8 text-white font-medium drop-shadow-lg">{tx("Klik om de video af te spelen")}</p>
                    <p className="mt-2 text-sm text-white/80 drop-shadow-lg">{tx("Duur: 3 minuten")}</p>
                  </div>
            ...
            <ScrollReveal delay={0.2}>
              <div className="flex flex-wrap justify-center gap-4 mt-10 max-w-2xl mx-auto">
                ...
                <span className="inline-flex items-center gap-2 rounded-full bg-white border border-warm-200 px-4 py-2 text-sm text-muted-foreground">
                  ...
                  {tx("Wat is zelfcompassie?")}
                </span>
                <span className="inline-flex items-center gap-2 rounded-full bg-white border border-warm-200 px-4 py-2 text-sm text-muted-foreground">
                  <Sparkles className="h-4 w-4 text-terracotta-500" />
                  {tx("Wat kun je verwachten?")}
                </span>
              </div>
            </ScrollReveal>
          </div>
          ...
          <div className="mx-auto max-w-4xl">
            <ScrollReveal>
              <div className="text-center mb-12">
                ...
                <h2 className="mb-8 text-3xl font-light text-foreground md:text-4xl lg:text-5xl leading-tight">
                  {tx("Wat is Mindful Zelfcompassie")}
                ...
                <p className="text-muted-foreground text-lg lg:text-xl max-w-2xl mx-auto leading-relaxed">
                  {tx("Mindful Zelfcompassie (MSC) is een wetenschappelijk onderbouwd 8-weeks programma, ontwikkeld door dr. Kristin Neff en dr. Christopher Germer.")}
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.1}>
              <div className="flex items-center justify-center gap-2 mb-10">
                ...
                <p className="text-foreground text-lg font-medium">{tx("Wat leer je in 8 weken?")}</p>
                <div className="h-px w-12 bg-terracotta-300" />
              </div>
            </ScrollReveal>
              ...
              <StaggerItem>
                <Card className="border-0 bg-white rounded-2xl hover:shadow-lg transition-all duration-300 shadow-sm">
                  <CardContent className="p-5 flex items-center gap-4">
                    ...
                    <div>
                      <span className="text-xs font-semibold text-terracotta-600 uppercase tracking-wide">{tx("Pijler 1")}</span>
                      <h3 className="text-lg font-semibold text-foreground">{tx("Mindfulness")}</h3>
                      <p className="text-muted-foreground text-sm">{tx("Bewust aanwezig zijn bij wat je ervaart.")}</p>
                    </div>
                  </CardContent>
                </Card>
              </StaggerItem>
              ...
              <StaggerItem>
                <Card className="border-0 bg-white rounded-2xl hover:shadow-lg transition-all duration-300 shadow-sm">
                  <CardContent className="p-5 flex items-center gap-4">
                    ...
                    <div>
                      <span className="text-xs font-semibold text-rose-600 uppercase tracking-wide">{tx("Pijler 2")}</span>
                      <h3 className="text-lg font-semibold text-foreground">{tx("Zelfcompassie")}</h3>
                      <p className="text-muted-foreground text-sm">{tx("Met vriendelijkheid en begrip op jezelf reageren.")}</p>
                    </div>
                  </CardContent>
                </Card>
              </StaggerItem>
            ...
            <ScrollReveal delay={0.2}>
              <div className="max-w-2xl mx-auto mb-10">
                <p className="text-center text-muted-foreground text-lg leading-relaxed mb-6">
                  {tx("Ontwikkel praktische vaardigheden om jezelf te ondersteunen — zoals je dat bij een goede vriend(in) zou doen.")}
                </p>

                <h3 className="text-center text-base font-medium text-foreground mb-4">{tx("Een greep uit de thema's:")}</h3>
                
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {[
                    { emoji: "🌿", title: tx("Basis van zelfcompassie") },
                    { emoji: "💛", title: tx("Vriendelijkheid voor jezelf") },
                    { emoji: "🎭", title: tx("Omgaan met moeilijke emoties") },
                    { emoji: "🌊", title: tx("Leven vanuit je waarden") },
                    { emoji: "✨", title: tx("Dankbaarheid & zelfwaardering") },
                  ].map((theme, i) => (
          ...
          <div className="mx-auto max-w-4xl">
            <ScrollReveal>
              <div className="text-center mb-10">
                ...
                <h2 className="mb-8 text-3xl font-light text-foreground md:text-4xl lg:text-5xl leading-tight">
                  {tx("Voor wie is deze training?")}
                  <span className="block font-serif italic text-terracotta-600 mt-2">{tx("Herken je jezelf hierin?")}</span>
                </h2>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.2}>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 max-w-3xl mx-auto mb-10">
                {[
                  { text: tx("Streng voor jezelf"), icon: "🌿" },
                  { text: tx("Perfectionistisch"), icon: "📏" },
                  { text: tx("Moeilijke emoties"), icon: "💭" },
                  { text: tx("Zoekt meer balans"), icon: "🪞" },
                ].map((item, index) => (
              ...
              <div className="bg-white rounded-3xl p-8 lg:p-10 shadow-md mb-8">
                ...
                <div className="flex items-center justify-center gap-2 mb-8">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-terracotta-700">{tx("Theorie")}</span>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-sage-700">{tx("Praktijk")}</span>
                  </div>
                  <div className="w-8 h-px bg-warm-300" />
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-warm-700">{tx("Integratie")}</span>
                  </div>
                </div>
                ...
                <p className="text-muted-foreground text-lg leading-relaxed text-center">
                  {tx("Elke sessie voelt als thuiskomen: een veilige en vertrouwde ruimte waarin je kunt ontdekken, oefenen en verbinden. Onze ervaren trainers werken met een")} <span className="inline-flex items-center gap-1.5 rounded-full bg-sage-100 px-3 py-1 text-sage-700 font-medium text-sm"><Star className="h-3 w-3" />{tx("trauma-sensitieve aanpak")}</span>{tx(", zodat jij je op je gemak voelt terwijl je nieuwe inzichten en vaardigheden ontwikkelt.")}
                </p>
              </div>
            </ScrollReveal>
          </div>
          ...
          <div className="mx-auto max-w-5xl">
            <ScrollReveal>
              <div className="text-center mb-16">
                ...
                <h2 className="mb-6 text-3xl font-light text-foreground md:text-4xl lg:text-5xl leading-tight">
                  {tx("Wat brengt MSC")} <span className="font-serif italic text-terracotta-600">{tx("je?")}</span>
                </h2>
                <div className="flex flex-wrap justify-center gap-3 mb-6">
                  ...
                  <span className="inline-flex items-center gap-1.5 rounded-full bg-terracotta-100 border border-terracotta-200 px-4 py-1.5 text-xs font-medium text-terracotta-700">
                    ...
                    {tx("Duurzame resultaten")}
                  </span>
                </div>
                <p className="text-muted-foreground text-lg lg:text-xl max-w-2xl mx-auto leading-relaxed">
                  {tx("Onderzoek laat zien dat MSC leidt tot duurzame, positieve veranderingen — wereldwijd bevestigd bij duizenden deelnemers.")}
                </p>
              </div>
            </ScrollReveal>
            ...
            <StaggerContainer className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {[
                { text: tx("Meer rust"), icon: Brain, stat: "↓ 36%", statLabel: tx("stress"), color: "terracotta" },
                { text: tx("Meer veerkracht"), icon: Heart, stat: "↑ 42%", statLabel: tx("coping"), color: "sage" },
                { text: tx("Minder stress"), icon: Leaf, stat: "↓ 43%", statLabel: tx("angst"), color: "terracotta" },
                { text: tx("Minder zelfkritiek"), icon: Sparkles, stat: "↑ 67%", statLabel: tx("zelfcompassie"), color: "sage" },
                { text: tx("Betere grenzen"), icon: Award, stat: "↑ 38%", statLabel: tx("zelfzorg"), color: "terracotta" },
                { text: tx("Meer verbinding"), icon: Users, stat: "↑ 29%", statLabel: tx("verbondenheid"), color: "sage" },
              ].map((item, index) => {
            ...
            <ScrollReveal delay={0.3}>
              <p className="text-xs text-muted-foreground text-center mt-8">
                {tx("* Gemiddelde resultaten uit meta-analyses van MSC-onderzoek (Neff & Germer, 2013-2023)")}
              </p>
            </ScrollReveal>
          </div>
        </div>
            ...
            <ScrollReveal>
              <div className="text-center mb-12">
                ...
                <h2 className="mb-8 text-3xl font-light text-foreground md:text-4xl leading-tight">
                  {tx("Programma &")} <span className="font-serif italic text-terracotta-600">{tx("Data")}</span>
                </h2>
              </div>
              ...
              <div className="text-center mb-10">
                <p className="text-muted-foreground text-lg max-w-2xl mx-auto leading-relaxed">
                  {tx("Iedereen bewandelt zijn of haar eigen pad. Soms wil je groeien in een groep, soms juist met persoonlijke begeleiding. Hieronder vind je de mogelijkheden.")}
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-16">
                <Card className="border-warm-200 bg-white hover:shadow-lg transition-all duration-300 rounded-2xl overflow-hidden group text-center">
                  <CardContent className="p-6">
                    ...
                    <h3 className="text-lg font-semibold text-foreground mb-1">{tx("🌿 Groepstraject")}</h3>
                    <p className="text-xs text-muted-foreground mb-3">{tx("Mindful zelfcompassie · 8 weken")}</p>
                    <p className="text-sm text-muted-foreground mb-4">{tx("Leer vriendelijker met jezelf omgaan, beter omgaan met stress en ervaar meer innerlijke rust.")}</p>
                ...
                <Card className="border-warm-200 bg-white hover:shadow-lg transition-all duration-300 rounded-2xl overflow-hidden group text-center">
                  <CardContent className="p-6">
                    ...
                    <h3 className="text-lg font-semibold text-foreground mb-1">{tx("🌿 Individueel Traject")}</h3>
                    <p className="text-xs text-muted-foreground mb-3">{tx("6-sessiepakket · incl. intake & reflectie")}</p>
                    <p className="text-sm text-muted-foreground mb-3">{tx("Persoonlijk, op maat begeleid worden en écht de diepte ingaan op jouw thema's.")}</p>
                    <span className="inline-block rounded-full bg-terracotta-100 px-2.5 py-0.5 text-[10px] font-semibold text-terracotta-700 mb-2">{tx("✨ Aanbieding")}</span>
                ...
                <Card className="border-warm-200 bg-white hover:shadow-lg transition-all duration-300 rounded-2xl overflow-hidden group text-center">
                  <CardContent className="p-6">
                    ...
                    <h3 className="text-lg font-semibold text-foreground mb-1">{tx("🌿 Individuele Sessie")}</h3>
                    <p className="text-xs text-muted-foreground mb-3">{tx("Los · kennismaking of verdieping")}</p>
                    <p className="text-sm text-muted-foreground mb-4">{tx("Boek een losse sessie rond een specifiek thema of als kennismaking.")}</p>
            ...
            <ScrollReveal delay={0.1}>
              <div className="mb-16">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-2xl font-medium text-foreground">{tx("8-weekse MSC Training")}</h3>
                </div>
                
                {/* Format Info */}
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                  <div className="text-center p-4 rounded-xl bg-white border border-warm-200">
                    <p className="text-sm text-muted-foreground mb-1">{tx("Format")}</p>
                    <p className="font-medium text-foreground">{tx("100% live online")}</p>
                  </div>
                  <div className="text-center p-4 rounded-xl bg-white border border-warm-200">
                    <p className="text-sm text-muted-foreground mb-1">{tx("Duur")}</p>
                    <p className="font-medium text-foreground">{tx("8 weken + retreat")}</p>
                  </div>
                  <div className="text-center p-4 rounded-xl bg-white border border-warm-200">
                    <p className="text-sm text-muted-foreground mb-1">{tx("Per sessie")}</p>
                    <p className="font-medium text-foreground">{tx("2 uur")}</p>
                  </div>
                  <div className="text-center p-4 rounded-xl bg-white border border-warm-200">
                    <p className="text-sm text-muted-foreground mb-1">{tx("Taal")}</p>
                    <p className="font-medium text-foreground">{tx("NL / EN")}</p>
                  </div>
                </div>
            ...
            <ScrollReveal delay={0.2}>
              <div className="mb-16">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-2xl font-medium text-foreground">{tx("Individueel Traject – 6-sessiepakket")}</h3>
                </div>
                
                <p className="text-terracotta-600 font-medium mb-4">
                  {tx("Wil je persoonlijk, op maat begeleid worden en écht de diepte ingaan op jouw thema's?")}
                </p>
                <p className="text-muted-foreground mb-6 max-w-2xl">
                  {tx("Dit pakket is ideaal voor wie een duurzame stap wil zetten. Inclusief intake en reflectiesessie.")}
                </p>

                <div className="grid md:grid-cols-2 gap-6 mb-8">
                  <Card className="border-warm-200 bg-white rounded-2xl">
                    <CardContent className="p-6">
                      <h4 className="font-medium text-foreground mb-4">{tx("Het pakket omvat:")}</h4>
                  ...
                  <Card className="border-warm-200 bg-white rounded-2xl">
                    <CardContent className="p-6 flex flex-col items-center justify-center text-center h-full">
                      ...
                      <span className="inline-block rounded-full bg-terracotta-100 px-3 py-1 text-xs font-semibold text-terracotta-700 mb-3">{tx("✨ Tijdelijke aanbieding")}</span>
                      ...
                      <p className="text-sm text-muted-foreground mb-6">{tx("voor het volledige traject")}</p>
                      <Button asChild className="bg-terracotta-600 hover:bg-terracotta-700 text-white rounded-full px-8">
                        <Link to="/contact">
                          {tx("Neem contact op")}
                          <ArrowRight className="ml-2 h-4 w-4" />
            ...
            <ScrollReveal delay={0.25}>
              <div className="mb-16">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-2xl font-medium text-foreground">{tx("Individuele Sessie (los)")}</h3>
                </div>
                ...
                <Card className="border-warm-200 bg-white hover:shadow-lg transition-all duration-300 rounded-2xl max-w-md">
                  <CardContent className="p-6">
                    ...
                    <h4 className="text-lg font-semibold text-foreground mb-1">{tx("Individuele sessie")}</h4>
                    <p className="text-xs text-muted-foreground mb-3 font-medium">{tx("Per sessie · kennismaking, verdieping of vervolg")}</p>
                    ...
                    <div className="pt-4 border-t border-warm-200 flex items-center justify-between">
                      <div>
                        <p className="text-xs text-muted-foreground">{tx("60 minuten")}</p>
                      ...
                      <Button asChild size="sm" className="bg-terracotta-600 hover:bg-terracotta-700 text-white rounded-full">
                        <Link to="/contact">{tx("Boek sessie")}</Link>
                      </Button>
                    </div>
                  </CardContent>
                </Card>
            ...
            <ScrollReveal>
              <div className="text-center mb-14">
                ...
                <p className="text-muted-foreground text-lg max-w-xl mx-auto">
                  {tx("Heb je vragen over de training? Hier vind je antwoorden op de meest gestelde vragen.")}
                </p>
              </div>
            </ScrollReveal>
              ...
              <Accordion type="single" collapsible className="space-y-4">
                ...
                >
                  <AccordionTrigger className="text-left font-medium text-foreground hover:no-underline py-5">
                    {tx("Heb ik ervaring nodig met meditatie?")}
                  </AccordionTrigger>
                  <AccordionContent className="text-muted-foreground pb-5 leading-relaxed">
                    {tx("Nee, geen ervaring nodig. De training is geschikt voor iedereen, of je nu nog nooit hebt gemediteerd of al jaren oefent. We beginnen bij de basis en bouwen stap voor stap op.")}
                  </AccordionContent>
                </AccordionItem>
                ...
                >
                  <AccordionTrigger className="text-left font-medium text-foreground hover:no-underline py-5">
                    {tx("Wat als ik een sessie mis?")}
                  </AccordionTrigger>
                  <AccordionContent className="text-muted-foreground pb-5 leading-relaxed">
                    {tx("Alle sessies worden opgenomen en zijn beschikbaar in de online leeromgeving. Je kunt de inhoud op je eigen tempo terugkijken. Daarnaast krijg je toegang tot extra materialen en oefeningen.")}
                  </AccordionContent>
                </AccordionItem>
                ...
                >
                  <AccordionTrigger className="text-left font-medium text-foreground hover:no-underline py-5">
                    {tx("Is de training ook geschikt bij trauma?")}
                  </AccordionTrigger>
                  <AccordionContent className="text-muted-foreground pb-5 leading-relaxed">
                    {tx("De training heeft een trauma-sensitieve benadering. Bij ernstige trauma's adviseren we eerst individuele begeleiding te volgen voordat je aan de groepstraining begint. Neem gerust contact op om te bespreken wat het beste bij jou past.")}
                  </AccordionContent>
                </AccordionItem>
                ...
                >
                  <AccordionTrigger className="text-left font-medium text-foreground hover:no-underline py-5">
                    {tx("Hoeveel tijd kost het per week?")}
                  </AccordionTrigger>
                  <AccordionContent className="text-muted-foreground pb-5 leading-relaxed">
                    {tx("Naast de wekelijkse sessies van 2 uur, is het aan te raden om dagelijks 20-30 minuten te oefenen. Dit is flexibel en kan worden aangepast aan jouw ritme. De oefeningen zijn ook in kortere versies beschikbaar.")}
                  </AccordionContent>
                </AccordionItem>
                ...
                >
                  <AccordionTrigger className="text-left font-medium text-foreground hover:no-underline py-5">
                    {tx("Kan ik in termijnen betalen?")}
                  </AccordionTrigger>
                  <AccordionContent className="text-muted-foreground pb-5 leading-relaxed">
                    {tx("Ja, betalen in termijnen is mogelijk. Neem contact op om de mogelijkheden te bespreken. We kijken graag samen naar een oplossing die bij jouw situatie past.")}
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            </ScrollReveal>
            ...
            <ScrollReveal>
              <div className="text-center mb-14">
                ...
                <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                  {tx("Ontdek hoe de MSC-training het leven van anderen heeft veranderd.")}
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.1}>
              ...
              >
                <CarouselContent className="-ml-4">
                  {[
                    {
                      quote: tx("Deze training heeft mijn relatie met mezelf volledig veranderd. Ik ben nu veel milder voor mezelf en dat straalt uit naar alles om me heen."),
                      name: "Marieke",
                      role: tx("Deelnemer voorjaar 2025"),
                    },
                    {
                      quote: tx("Eindelijk begrijp ik dat zelfcompassie geen zwakte is, maar juist kracht geeft. De oefeningen gebruik ik nog dagelijks."),
                      name: "Thomas",
                      role: tx("Deelnemer najaar 2024"),
                    },
                    {
                      quote: tx("De veilige sfeer in de groep maakte het mogelijk om echt open te zijn. Een transformerende ervaring die ik iedereen gun."),
                      name: "Sandra",
                      role: tx("Deelnemer zomer 2025"),
                    },
                    {
                      quote: tx("Als perfectionist was zelfkritiek mijn tweede natuur. Nu heb ik tools om mezelf met meer vriendelijkheid te benaderen."),
                      name: "Erik",
                      role: tx("Deelnemer voorjaar 2024"),
                    },
                    {
                      quote: tx("De combinatie van theorie en praktijk werkt heel goed. Je begrijpt niet alleen wat zelfcompassie is, maar voelt het ook echt."),
                      name: "Lotte",
                      role: tx("Deelnemer winter 2024"),
                    },
                    {
                      quote: tx("Ik had niet verwacht dat 8 weken zo'n impact konden hebben. Dit is een cadeau aan mezelf dat blijft geven."),
                      name: "Jasper",
                      role: tx("Deelnemer najaar 2025"),
                    },
          ...
          <div className="mx-auto max-w-4xl">
            <ScrollReveal>
              <div className="text-center mb-12">
                ...
                <h2 className="mb-6 text-3xl font-light text-foreground md:text-4xl leading-tight">
                  {tx("Startdata")} <span className="font-serif italic text-terracotta-600">{tx("groepstraining")}</span>
                </h2>
              </div>
            </ScrollReveal>
              ...
              <div className="lg:col-span-2">
                <ScrollReveal>
                  ...
                  <p className="text-muted-foreground mb-8 leading-relaxed">
                    {tx("Neem gerust contact met ons op. We reageren meestal binnen 24 uur.")}
                  </p>
            ...
            <div className="grid gap-10 md:grid-cols-2 mb-12">
              <div>
                ...
                <p className="text-muted-foreground text-lg">
                  {tx("Begeleiding in Mindful Zelfcompassie")}
                </p>
              </div>
              <div className="space-y-4">
