...
import { Heart, Users, ArrowRight, Mail, Phone, MessageCircle, Check, Leaf, Calendar, Clock, Globe, Video, Sparkles } from "lucide-react";
      ...
      <section className="relative overflow-hidden pt-24 pb-28 lg:pt-32 lg:pb-36">
        ...
        <div className="container relative mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="mb-8 text-5xl font-light tracking-tight text-foreground md:text-6xl lg:text-7xl leading-[1.1]">
              Kom thuis
              <span className="block font-serif italic text-terracotta-600 mt-2">bij jezelf!</span>
            </h1>
            
            <p className="mb-5 text-xl text-terracotta-600 font-medium md:text-2xl tracking-wide">
              8-weekse training in Mindful Zelfcompassie
            </p>
            
            <p className="mb-12 text-muted-foreground text-lg max-w-lg mx-auto leading-relaxed">
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl">
            ...
            <div className="grid gap-6 md:grid-cols-2 mb-12">
              <div className="group flex items-start gap-5 bg-white rounded-3xl p-7 shadow-sm border border-warm-200 hover:shadow-md transition-shadow">
      ...
      <section className="py-24 lg:py-28 bg-white">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <div className="space-y-4 max-w-lg mx-auto text-left mb-12">
              {[
                ...
                <div key={index} className="flex items-center gap-4 bg-gradient-to-r from-warm-50 to-sage-50 rounded-2xl px-6 py-5 border border-warm-200">
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              {[
                ...
                <div key={index} className="flex items-center gap-4 p-5 rounded-2xl bg-gradient-to-r from-terracotta-50 to-warm-50 border border-terracotta-100 hover:shadow-sm transition-shadow">
      ...
      <section className="py-24 lg:py-28 bg-warm-50">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl">
            ...
            {/* Format info */}
            <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-4 mb-14 max-w-3xl mx-auto">
              {[
                ...
                <div key={index} className="flex items-center gap-3 bg-white rounded-2xl px-5 py-4 border border-warm-200 shadow-sm">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {trainingDates.map((training, index) => (
                <Card key={index} className="border-warm-200 bg-white overflow-hidden rounded-3xl shadow-sm hover:shadow-md transition-shadow">
