...
import { Heart, ArrowRight, Mail, Phone, MessageCircle, Calendar, Clock, Globe, Users, Sparkles, Mountain, BookOpen, Compass } from "lucide-react";
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="grid gap-6 md:grid-cols-2 mb-12">
              <Card className="border-warm-200 bg-gradient-to-br from-warm-50 to-white rounded-3xl overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <Card className="border-warm-200 bg-gradient-to-br from-terracotta-50 to-white rounded-3xl overflow-hidden hover:shadow-lg transition-shadow">
                <CardContent className="p-8">
